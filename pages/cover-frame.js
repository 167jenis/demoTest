...
const CoverFrame = () => {
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      <div className="relative bg-primary-contrast w-full h-[960px] overflow-hidden text-left text-xl text-primary-contrast font-roboto">
        ...
        />
        <img
          className="absolute h-[7.2%] w-[22.92%] top-[44.34%] right-[3.36%] bottom-[48.46%] left-[73.72%] max-w-full overflow-hidden max-h-full object-cover"
          alt=""
          src="/group-17.png"
        />
        ...
        <div className="absolute top-[53.25px] left-[56px] rounded-2xl bg-primary-contrast w-[1076.45px] h-[850.71px] overflow-hidden flex flex-col items-center justify-start gap-[51.58px] text-center text-[13.46px] hover:[background:linear-gradient(#fff,_#fff),_#87550a] sm:w-full sm:hover:bg-orange">
          <div className="self-stretch flex flex-col items-center justify-start text-[45.6px] font-baloo-bhai">
            <header className="self-stretch bg-primary-contrast h-[57.56px] flex flex-row items-center justify-center py-[16.445871353149414px] px-[59.803165435791016px] box-border sticky w-full top-[0] [background:white] text-left text-[10.47px] text-darkslategray-200 font-roboto lg:pl-10 lg:pr-10 lg:box-border md:pl-6 md:pr-6 md:box-border">
              <div className="flex-1 flex flex-row items-center justify-between">
                <img
                  className="relative w-[130.07px] h-[24.67px] overflow-hidden shrink-0 object-cover"
                  alt=""
                  src="/fickleflight-logo.png"
                />
                <div className="shrink-0 flex flex-row items-center justify-end gap-[26.91px] sm:flex">
                  <div className="shrink-0 flex flex-row items-center justify-end gap-[22.43px] md:hidden">
                  ...
                  <div className="shrink-0 flex flex-row items-center justify-center gap-[8.97px]">
                    <img
            ...
            <div className="self-stretch relative h-[478.43px]">
              ...
              />
              <div className="absolute top-[0px] left-[0px] w-full h-[478.43px] flex flex-col items-center justify-center py-0 px-[104.6555404663086px] box-border gap-[32.14px] md:pl-[30px] md:pr-[30px] md:box-border">
                ...
                <div className="self-stretch rounded-[7.48px] bg-primary-contrast flex flex-row items-start justify-start p-[14.950791358947754px] text-left text-[8.97px] text-gray-400 font-roboto md:flex-col">
                  <div className="flex-1 shrink-0 flex flex-row items-start justify-start md:w-full md:flex-[unset] md:self-stretch sm:flex-col">
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-[3.7376978397369385px] sm:w-full sm:flex-[unset] sm:self-stretch">
                      <div className="self-stretch h-[41.86px] flex flex-col items-start justify-start">
                        <div className="self-stretch rounded-[2.99px] box-border h-[41.86px] flex flex-col items-start justify-start py-0 px-[8.970474243164062px] border-[0.7px] border-solid border-gray-300">
                          ...
                          <div className="self-stretch overflow-hidden flex flex-row items-center justify-start py-[11.213094711303711px] px-0 gap-[5.98px] text-center text-dimgray">
                            <div className="shrink-0 hidden flex-row items-start justify-start gap-[5.98px]">
                              <div className="shrink-0 flex flex-col items-start justify-start">
                                <div className="rounded-[11.96px] bg-gainsboro-100 shrink-0 flex flex-row items-center justify-start p-[2.9901583194732666px]">
                                  ...
                                  <div className="shrink-0 flex flex-col items-start justify-start py-[2.2426187992095947px] px-[4.4852375984191895px] text-left text-[9.72px] text-gray-200">
                                    <div className="relative tracking-[0.12px] leading-[13.46px]">
                                      Chip
                                    </div>
                                  </div>
                                  <img
                                    className="relative w-[17.94px] h-[17.94px] overflow-hidden shrink-0 object-cover"
                                    alt=""
                                    src="/cancel.png"
                                  />
                                </div>
                            ...
                            <div className="flex-1 relative text-[11.96px] tracking-[0.11px] leading-[17.94px] text-gray-200 text-left">
                              Los Angeles (LA)
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="shrink-0 flex flex-col items-center justify-center p-[3.7376978397369385px] text-center text-[11.21px] text-primary-contrast md:w-full md:text-left">
          ...
          <div className="w-full flex flex-col items-center justify-start py-0 px-[59.803165435791016px] box-border gap-[59.8px] max-w-[1280px] text-left text-darkslategray-300 md:pl-[30px] md:pr-[30px] md:box-border">
            <div className="self-stretch flex flex-col items-start justify-start gap-[14.95px] md:block">
              ...
              <div className="self-stretch flex flex-row items-start justify-start gap-[26.91px] text-[17.94px] text-cornflowerblue-300 md:flex-col">
                <div className="rounded-[5.98px] shrink-0 flex flex-col items-start justify-start p-[14.950791358947754px] gap-[15.7px] border-[0.7px] border-solid border-whitesmoke lg:w-[520px] md:w-full md:block md:mb-[30px]">
                  <div className="self-stretch shrink-0 flex flex-row items-center justify-between">
                    ...
                    <div className="relative w-[87.72px] h-[32.96px] text-[10.47px] text-gray-100">
                      ...
                      <img
                        className="absolute top-[0px] left-[0px] w-[87.72px] h-[17.94px] object-cover"
                        alt=""
                        src="/group-171.png"
                      />
                    </div>
                  ...
                  <div className="self-stretch shrink-0 flex flex-row items-center justify-between text-[10.47px] text-gray-100">
                ...
                <div className="flex-1 flex flex-col items-start justify-start gap-[14.95px] text-[13.46px] text-lightgray md:w-full md:flex-[unset] md:self-stretch">
                  ...
                  <div className="self-stretch flex flex-row items-start justify-between sm:flex-row sm:text-center sm:flex-wrap sm:justify-between sm:ml-[-28px] sm:mr-[-28px]">
                    <button className="cursor-pointer [border:none] p-0 bg-[transparent] shrink-0 flex flex-col items-center justify-center gap-[5.98px] sm:pb-5 sm:box-border sm:w-[33.33%] sm:text-center">
                      <img
                        className="relative w-[48.88px] h-[48.88px] object-cover"
                        alt=""
                        src="/group-21.png"
                      />
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-[17.94px] text-cornflowerblue-300">
              <div className="self-stretch flex flex-row items-center justify-start sm:flex-col sm:self-start">
                ...
                <a className="[text-decoration:none] rounded-[23.17px] bg-primary-contrast w-[172.97px] shrink-0 flex flex-row items-start justify-start gap-[7.48px] text-right text-[inherit] md:hidden">
              ...
              <div className="self-stretch flex flex-row items-start justify-start ml-[-16px] mr-[-16px] md:ml-[-16px] md:mr-[-16px] md:flex-wrap md:mt-[-16px] md:mb-[-16px]">
                <button className="cursor-pointer [border:none] py-0 px-[11.960633277893066px] bg-[transparent] w-3/12 flex flex-col items-center justify-center box-border md:p-4 md:box-border md:w-6/12 sm:w-full">
                  <div className="self-stretch relative rounded-[7.48px] h-[136.05px] overflow-hidden shrink-0">
                    ...
                    />
                    <div className="absolute w-[calc(100%_-_0.44px)] top-[0px] right-[0.22px] left-[0.22px] flex flex-row items-start justify-start py-[5.980316638946533px] px-[8.970474243164062px] box-border">
                      <b className="flex-1 relative text-[14.95px] tracking-[0.02em] font-roboto text-primary-contrast text-left">
                        Paris
                      </b>
                      <div className="relative w-[67.97px] h-[44.1px]">
                        ...
                        <div className="absolute top-[0px] left-[28.7px] text-[11.96px] tracking-[0.04em] uppercase font-roboto text-primary-contrast text-right inline-block w-[39.27px] h-[14.2px]">
                          from
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="self-stretch relative rounded-[7.48px] h-[136.05px] overflow-hidden shrink-0">
                    ...
                    <div className="absolute w-[calc(100%_-_0.44px)] top-[0px] right-[0.22px] left-[0.22px] flex flex-row items-start justify-start py-[5.980316638946533px] px-[8.970474243164062px] box-border">
                      ...
                      <div className="relative w-[74.7px] h-[44.1px]">
                        ...
                        <div className="absolute top-[0px] left-[35.43px] text-[11.96px] tracking-[0.04em] uppercase font-roboto text-primary-contrast text-right inline-block w-[39.27px] h-[14.2px]">
                          from
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="self-stretch relative rounded-[7.48px] h-[136.05px] overflow-hidden shrink-0">
                    ...
                    <div className="absolute w-[calc(100%_-_0.44px)] top-[0px] right-[0.22px] left-[0.22px] flex flex-row items-start justify-start py-[5.980316638946533px] px-[8.970474243164062px] box-border">
                      ...
                      <div className="relative w-[75.22px] h-[44.1px]">
                        ...
                        <div className="absolute top-[0px] left-[35.95px] text-[11.96px] tracking-[0.04em] uppercase font-roboto text-primary-contrast text-right inline-block w-[39.27px] h-[14.2px]">
                          from
                        </div>
                      </div>
                    </div>
            ...
            <div className="self-stretch flex flex-col items-start justify-center gap-[17.94px] text-[22.43px]">
              <div className="self-stretch flex flex-row items-center justify-start">
                ...
                <a className="[text-decoration:none] rounded-[23.17px] bg-primary-contrast w-[149.43px] shrink-0 flex flex-row items-start justify-start gap-[7.48px] text-right text-[13.46px] text-cornflowerblue-300 md:hidden">
              ...
              <div className="self-stretch flex flex-row items-start justify-start ml-[-16px] mr-[-16px] md:ml-[-16px] md:mr-[-16px] md:flex-wrap">
                ...
                <button className="cursor-pointer [border:none] py-0 px-[11.960633277893066px] bg-[transparent] flex-1 flex flex-col items-center justify-start box-border w-3/12 md:w-6/12 sm:w-full sm:mb-8">
                  <img
                    className="self-stretch relative rounded-t-[7.48px] rounded-b-none max-w-full overflow-hidden h-[180.9px] shrink-0 object-cover"
                    alt=""
                ...
                <button className="cursor-pointer [border:none] py-0 px-[11.960633277893066px] bg-[transparent] flex-1 flex flex-col items-center justify-start box-border w-3/12 md:w-6/12 sm:w-full">
                  <img
                    className="self-stretch relative rounded-t-[7.48px] rounded-b-none max-w-full overflow-hidden h-[180.9px] shrink-0 object-cover"
                    alt=""
            ...
            <form className="m-0 self-stretch flex flex-col items-start justify-start gap-[14.95px]">
              <div className="self-stretch flex flex-row items-center justify-center">
                <div className="flex-1 relative h-[26.16px]">
                  <b className="absolute top-[0px] left-[0px] text-[22.43px] tracking-[0.04em] capitalize inline-block font-roboto text-darkslategray-300 text-left w-[826.29px] h-[26.16px] sm:text-3xl">
                    Popular Stays
                  </b>
                </div>
                <a className="[text-decoration:none] rounded-[23.17px] bg-primary-contrast shrink-0 flex flex-row items-start justify-start gap-[7.48px] md:hidden">
                  <div className="relative text-[13.46px] tracking-[0.04em] font-medium font-roboto text-cornflowerblue-300 text-right inline-block w-[105.15px] shrink-0">
                    View all stays
                  </div>
                  <img
                    className="relative w-[17.94px] h-[17.94px] overflow-hidden shrink-0 object-cover"
              ...
              <div className="self-stretch flex flex-row items-center justify-start ml-[-12px] mr-[-12px] lg:pr-10 lg:box-border lg:ml-[-12px] lg:mr-[-50px] md:mr-[-50px] md:ml-[-12px] sm:flex-col sm:pr-0 sm:box-border sm:mr-[-12px] sm:ml-[-12px]">
                <div className="self-stretch flex-1 shrink-0 flex flex-row items-start justify-center py-0 px-[8.970474243164062px] box-border w-3/12 md:w-[33.33%] sm:w-full sm:flex-[unset] sm:self-stretch">
                  <a className="[text-decoration:none] self-stretch flex-1 rounded-[7.48px] bg-primary-contrast box-border flex flex-col items-start justify-start py-[11.213094711303711px] px-[9.71801471710205px] gap-[17.19px] w-3/12 border-[0.7px] border-solid border-whitesmoke hover:bg-gainsboro-200 lg:w-[25%!important] md:w-full sm:w-[100%!important] sm:mb-5">
                    <img
                    ...
                    <div className="self-stretch flex flex-row items-start justify-start gap-[8.22px]">
                      <div className="flex-1 flex flex-col items-start justify-start gap-[4.49px]">
                        <div className="self-stretch relative text-[11.96px] tracking-[0.02em] font-roboto text-gray-100 text-left">
                          Entire bungalow
                        </div>
                        <b className="self-stretch relative text-[16.45px] tracking-[0.04em] capitalize font-roboto text-darkslategray-300 text-left sm:text-xl">
                          Matterhorn Suites
                        </b>
                        <div className="self-stretch relative text-[13.46px] tracking-[0.04em] font-roboto text-darkslategray-300 text-left">
                          $575/night
                        </div>
                      </div>
                      <img
                        className="relative w-[18.69px] h-[18.69px] overflow-hidden shrink-0 object-cover"
                        alt=""
                        src="/video.png"
                      />
                    </div>
                    <div className="self-stretch relative h-[14.2px]">
                      <div className="absolute top-[0px] left-[40.09px] text-[11.96px] tracking-[0.04em] font-roboto text-cornflowerblue-200 text-left inline-block w-[161.74px] h-[14.2px]">
                        (60 reviews)
                      </div>
                      <div className="absolute top-[0px] left-[0px] w-[33.15px] h-[14.2px]">
                        <div className="absolute top-[0px] left-[15.21px] text-[11.96px] tracking-[0.04em] font-medium font-roboto text-darkslategray-300 text-left inline-block w-[17.94px] h-[14.2px]">
                          4.9
                        </div>
                        <img
                          className="absolute h-[90.47%] w-[37.54%] top-[0%] right-[62.46%] bottom-[9.53%] left-[0%] max-w-full overflow-hidden max-h-full object-cover"
                          alt=""
                          src="/vector3.png"
                        />
                      </div>
                    ...
                    <button className="cursor-pointer p-0 bg-[transparent] self-stretch rounded-[2.99px] box-border h-[34.39px] overflow-hidden shrink-0 flex flex-col items-center justify-center border-[0.7px] border-solid border-lavender sm:w-[100%!important]">
                      <div className="relative text-[11.21px] tracking-[0.34px] leading-[19.44px] uppercase font-medium font-roboto text-cornflowerblue-200 text-left inline-block w-[81.48px] h-[19.44px] shrink-0">
                        More details
                      </div>
                    </button>
                  </a>
                </div>
                <div className="self-stretch flex-1 flex flex-row items-start justify-center py-0 px-[8.970474243164062px] box-border w-3/12 md:w-[33.33%] sm:w-full sm:flex-[unset] sm:self-stretch">
                  <a className="[text-decoration:none] self-stretch flex-1 rounded-[7.48px] bg-primary-contrast box-border flex flex-col items-start justify-start py-[11.213094711303711px] px-[9.71801471710205px] gap-[17.19px] w-3/12 border-[0.7px] border-solid border-whitesmoke hover:bg-gainsboro-200 lg:w-[25%!important] md:w-full sm:w-[100%!important] sm:mb-5">
                    <img
                      className="self-stretch relative rounded-[7.48px] max-w-full overflow-hidden h-[149.51px] shrink-0 object-cover"
                      alt=""
                ...
                <div className="self-stretch flex-1 flex flex-row items-start justify-center py-0 px-[8.970474243164062px] box-border w-3/12 md:w-[33.33%] sm:w-full sm:flex-[unset] sm:self-stretch">
                  <a className="[text-decoration:none] self-stretch flex-1 rounded-[7.48px] bg-primary-contrast box-border flex flex-col items-start justify-start py-[11.213094711303711px] px-[9.71801471710205px] gap-[17.19px] w-3/12 border-[0.7px] border-solid border-whitesmoke hover:bg-gainsboro-200 lg:w-[25%!important] md:w-full sm:flex sm:w-[100%!important]">
                    <img
                      className="self-stretch relative rounded-[7.48px] max-w-full overflow-hidden h-[149.51px] shrink-0 object-cover"
                      alt=""
                    ...
                    <div className="self-stretch flex-1 flex flex-row items-start justify-start">
                      <div className="flex-1 flex flex-col items-start justify-start gap-[4.49px]">
                        ...
                        <b className="self-stretch relative text-[16.45px] tracking-[0.04em] capitalize font-roboto text-darkslategray-300 text-left">{`Arctic Hut `}</b>
                        <div className="self-stretch relative text-[13.46px] tracking-[0.04em] font-roboto text-darkslategray-300 text-left">
                          $420/night
                        </div>
                      </div>
                    ...
                    <div className="self-stretch relative h-[14.2px]">
                      <div className="absolute top-[0px] left-[40.17px] text-[11.96px] tracking-[0.04em] font-roboto text-cornflowerblue-200 text-left inline-block w-[161.67px] h-[14.2px]">
                        (78 reviews)
                      </div>
                      <div className="absolute top-[0px] left-[0px] w-[33.18px] h-[14.2px]">
                        <div className="absolute top-[0px] left-[15.23px] text-[11.96px] tracking-[0.04em] font-medium font-roboto text-darkslategray-300 text-left inline-block w-[17.94px] h-[14.2px]">
                          4.7
                        </div>
                        <img
                          className="absolute h-[90.47%] w-[37.58%] top-[0%] right-[62.42%] bottom-[9.53%] left-[0%] max-w-full overflow-hidden max-h-full object-cover"
                          alt=""
                          src="/vector5.png"
                        />
                      </div>
                ...
                <div className="self-stretch flex-1 shrink-0 flex flex-row items-start justify-center py-0 px-[8.970474243164062px] box-border w-3/12 md:hidden md:w-[33.33%] sm:flex-[unset] sm:self-stretch">
                  <a className="[text-decoration:none] self-stretch flex-1 rounded-[7.48px] bg-primary-contrast box-border flex flex-col items-start justify-start py-[11.213094711303711px] px-[9.71801471710205px] gap-[17.19px] w-3/12 border-[0.7px] border-solid border-whitesmoke hover:bg-gainsboro-200 lg:w-[25%!important] md:w-[33.33%!important] sm:flex sm:w-[100%!important]">
                    <img
                      className="self-stretch relative rounded-[7.48px] max-w-full overflow-hidden h-[149.51px] shrink-0 object-cover"
                      alt=""
                    ...
                    <div className="self-stretch flex flex-row items-start justify-start gap-[8.22px]">
                      <div className="flex-1 flex flex-col items-start justify-start gap-[4.49px]">
                        ...
                        <b className="self-stretch relative text-[16.45px] tracking-[0.04em] capitalize font-roboto text-darkslategray-300 text-left">
                          Lake Louise Inn
                        </b>
                        <div className="self-stretch relative text-[13.46px] tracking-[0.04em] font-roboto text-darkslategray-300 text-left">
                          $244/night
              ...
              <div className="rounded-[23.17px] bg-primary-contrast hidden flex-row items-start justify-start gap-[7.48px] md:flex md:mt-4">
                <div className="relative text-[13.46px] tracking-[0.04em] font-medium font-roboto text-cornflowerblue-300 text-right inline-block w-[105.15px] shrink-0 md:w-auto">
                  View all stays
                </div>
                <img
                  className="relative w-[17.94px] h-[17.94px] overflow-hidden shrink-0 object-cover"
          ...
          <div className="self-stretch flex flex-col items-start justify-start text-cornflowerblue-300">
            <div className="self-stretch relative bg-aliceblue h-[395.45px] overflow-hidden shrink-0">
              ...
              />
              <div className="[position:relative!important] top-[38.87px] left-[auto!important] w-[410.4px] flex flex-col items-center justify-start p-[14.950791358947754px] box-border gap-[22.43px] ml-[auto] mr-[auto] md:py-6 md:px-0 md:box-border sm:pl-6 sm:pr-6 sm:box-border sm:ml-[auto] sm:mr-[auto] sm:[position:relative!important] sm:left-[auto!important] sm:w-full">
                ...
                <div className="self-stretch rounded-[8.97px] bg-primary-contrast shadow-[0px_0px_17.94px_rgba(0,_0,_0,_0.03)] flex flex-col items-start justify-start py-[20.931108474731445px] px-[22.426189422607422px] gap-[12.71px] text-left text-slategray border-[0.7px] border-solid border-whitesmoke">
                  ...
                  <div className="self-stretch flex flex-col items-start justify-start gap-[7.48px]">
                    <div className="self-stretch flex flex-col items-start justify-start">
                      <TextField
                        className="[border:none] bg-[transparent] self-stretch font-roboto text-[11.96px] text-gray-400"
                        color="primary"
                        label="Your name"
                        size="medium"
                        variant="outlined"
            ...
            <footer className="self-stretch [background:linear-gradient(91.74deg,_#0b5ba8_25.38%,_#299bd8)] flex flex-row items-start justify-start py-[24.668806076049805px] px-[62.7933235168457px] gap-[32.89px] text-left text-[13.46px] text-primary-contrast font-roboto lg:p-10 lg:box-border md:flex-col md:pt-10 md:px-6 md:pb-[30px] md:box-border sm:py-[30px] sm:px-6 sm:box-border">
              <div className="flex-1 flex flex-col items-start justify-start gap-[10.47px] mb-[40px!important] md:flex-[unset] md:self-stretch">
                ...
                <img
                  className="relative w-[97.18px] h-[22.43px] object-cover"
                  alt=""
              ...
              <div className="flex-1 shrink-0 flex flex-row items-start justify-between text-[11.96px] md:flex-[unset] md:self-stretch sm:flex-col">
